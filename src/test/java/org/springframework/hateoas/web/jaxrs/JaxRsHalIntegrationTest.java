...
import static org.springframework.hateoas.web.jaxrs.JaxRsLinkBuilder.*;
 ...
 */
public class JaxRsHalIntegrationTest extends JerseyTest {

	private final static Map<Integer, Employee> EMPLOYEES = new TreeMap<>();
	private final static String MEDIA_TYPE = MediaTypes.HAL_JSON_VALUE;
